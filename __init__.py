...
_multi_angle_node = _import_node_module("qwen_multi_angle_node")
MULTI_ANGLE_NODE_CLASS_MAPPINGS = _multi_angle_node.NODE_CLASS_MAPPINGS
MULTI_ANGLE_DISPLAY_NAME_MAPPINGS = _multi_angle_node.NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS = {
    ...
    **MULTI_ANGLE_NODE_CLASS_MAPPINGS,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **MULTI_ANGLE_DISPLAY_NAME_MAPPINGS,
}

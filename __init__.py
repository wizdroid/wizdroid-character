...
_qwen_image_edit_node = _import_node_module("qwen_image_edit_node")
QWEN_IMAGE_EDIT_NODE_CLASS_MAPPINGS = _qwen_image_edit_node.NODE_CLASS_MAPPINGS
QWEN_IMAGE_EDIT_DISPLAY_NAME_MAPPINGS = _qwen_image_edit_node.NODE_DISPLAY_NAME_MAPPINGS
...
NODE_CLASS_MAPPINGS = {
    ...
    **QWEN_IMAGE_EDIT_NODE_CLASS_MAPPINGS,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **QWEN_IMAGE_EDIT_DISPLAY_NAME_MAPPINGS,
}

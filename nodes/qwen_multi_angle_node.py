...
REF_PROMPT_TEMPLATES = {
    ...
    "background": "Use image {index} as background reference — match the environment and setting exactly.",
    "lighting": "Use image {index} as lighting reference — replicate the lighting setup, shadows, highlights, and illumination exactly.",

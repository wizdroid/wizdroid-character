"""📷 Photography Style Selector Node - Select photographic styles and output style-transfer prompts."""
...
class WizdroidPhotographyStyleNode:
    """📷 Select a photography style and output its style-transfer prompt.

    Provides a curated collection of 15 photography styles
    (Film Noir, Vintage Polaroid, HDR, Tilt-Shift, Macro, Long Exposure,
    Neon Noir, Cinematic, Silhouette, Analog Film, etc.).
    Each style includes a detailed prompt description suitable for style transfer.
    ...
    @classmethod
    def INPUT_TYPES(cls):
        styles = DataRegistry.get_photography_styles()
        ...
        return {
            "required": {
                ...
                "user_subject": ("STRING", {"multiline": True, "default": "", "placeholder": "Describe your subject/scene here... e.g. a person at sunset, a city street"}),
            }
        }
    ...
    def get_style(
        ...
        system_prompt = load_system_prompt_text("system_prompts/photography_style_system.txt")

        user_prompt = (
            f"Target Photography Style: {style_name}\n"
        ...
        user_prompt += (
            ...
            "Focus exclusively on applying the photographic treatment (lighting, exposure, depth of field, color grading, lens effects, film stock).\n"
            "Do NOT add new subjects, backgrounds, or scene elements.\n"
            "Only change how the existing image is photographically rendered."
        )
...
NODE_CLASS_MAPPINGS = {
    "WizdroidPhotographyStyleNode": WizdroidPhotographyStyleNode,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WizdroidPhotographyStyleNode": "📷 Photography Style Selector",
}
